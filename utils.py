...
class Utils:
    ...
    all_items = {
        ...
        "condoms": Item("condoms", "презерватив", "🍌",
                        ...
                        ["презерватив", "презерватива", "презервативов"], 70),
